...
public final class EhrReportConstants {
	...
	public static final String POPC_PAEDIATRICS_CLINIC = "da4903d2-7ae3-4c52-929a-ae7273b9e68e"; // 5122
	
	public static final String CCC_CLINIC = "e0620e9e-be40-43b1-b18d-b4ed2498b13c"; // 5699
	
	public static final String MOPC_DM_DIABETIC_CLINIC = "b1801fa9-7a27-450f-ae06-04333287ffb1"; // 5701
	...
	public static final String PALLIATIVE_CARE_CLINIC = "8c4f488d-0d85-4782-b82c-59f454299f01"; // 5706
	...
	public static final String FAMILY_PLANNING_CLINIC = "68f095fb-1701-42b1-bd30-46d5f0473ae6"; // 100126248
	...
	public static final String DIARRHOEA_AND_GASTROENTERITIS_OF_PRESUMED_INFECTIOUS_ORIGIN = "882643b0-55aa-4385-9aee-9a017bc8c6a4"; // 1678
	
	public static final String Hemorrhagic_Diarrhea = "138868AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"; // 138868
	
	public static final String Bacterial_Gastroenteritis = "148023AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"; // 148023
	...
	public static final String TUBERCULOSIS_IN_PREGNANCY = "75278919-cd62-49d1-bb76-48243d206eb3"; // 4592
	...
	public static final String CRYPTOCOCCAL_MENINGITIS = "0eef9672-84c4-40fc-a679-055f3e58ac76"; // 1179
	...
	public static final String MEASLES_WITHOUT_COMPLICATION = "54f63bbc-bc55-4078-9fc9-8096fcde9a09"; // 4458
	...
	public static final String LIVER_INFECTION_WITH_HEPATITIS_A = "e6dfba35-671f-4b67-a575-9fff1161e926"; // 1005
	
	// MUMPS
	public static final String MUMPS = "c196599b-4a7e-47a7-8e6c-53219350029e"; // 1021
	
	// FEVERS
	public static final String RESPIRATORY_DISTRESS_HAEMORRHAGIC_FEVERS = "edfbdd2c-fb7a-47ea-81ef-608414cf6164"; // 3671
	
	public static final String FEVER = "17aa2537-707d-49a9-96bd-d2ae6bbe8a6b"; // 1202
	
	public static final String FEVER_OF_UNKNOWN_ORIGIN = "c6516631-c608-419c-81d6-0d7e95202090"; // 1152
	...
	public static final String PLASMODIUM_FALCIPARUM_MALARIA_UNSPECIFIED = "b2370662-2bd1-4522-8fcb-1b626b5592b0"; // 705
	
	public static final String OTHER_MALARIA_NOT_ELSEWHERE_CLASSIFIED = "8e83be01-17d3-4cf0-9f2c-c22d482b8138"; // 4055
	
	public static final String CONGENITAL_FALCIPARUM_MALARIA = "a66eb37f-5ce0-4066-ad34-539a04c5a713"; // 4267
	
	public static final String PLASMODIUM_FALCIPARUM_MALARIA = "246639aa-efdb-4a32-9303-e08f6e423e18"; // 4314
	
	public static final String PLASMODIUM_VIVAX_MALARIA = "f42394df-f2d2-43d0-9144-6e3dfafbfa15"; // 4515
	
	public static final String Malaria_confirmed_with_minor_digestive_symptoms = "160150AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"; // 160150
	
	public static final String Presumptive_Malaria_With_Pregnancy = "160151AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"; // 160151
	
	public static final String Confirmed_Malaria_With_Pregnancy = "160152AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"; // 160152
	
	public static final String Presumptive_malaria_with_minor_digestive_symptoms_pregnant = "160153AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"; // 160153
	
	public static final String Confirmed_malaria_with_minor_digestive_symptoms_pregnant = "160154AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"; // 160154
	
	public static final String SEVERE_MALARIA = "160155AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"; // 160155
	
	// URINARY TRACT INFECTION
	public static final String URINARY_TRACT_INFECTION = "d1147870-eb23-417b-b879-417dd9fe4293"; // 1017
	
	public static final String URINARY_TRACT_INFECTION_IN_PREGNANCY = "bcdc81a8-63e5-4f8a-b09d-6a358903c06b"; // 2522
	
	public static final String URINARY_TRACT_INFECTION_IN_PREGNANCY_NOT_SPECIFIED = "f6764c58-18c0-4033-abcb-938c867cdf2d"; // 4292
	
	public static final String INFECTION_OF_OTHER_STOMA_OF_URINARY_TRACT = "7718f725-8380-4aba-b810-ab895097dd17"; // 4376
	
	public static final String INFECTIONS_OF_OTHER_PARTS_OF_URINARY_TRACT_IN_PREGNANCY = "e3078356-7c35-4214-8ea8-71ea78218f7f"; // 4443
	...
	public static final String PROTEIN_ENERGY_MALNUTRITION = "0ee5e782-13bc-4b90-951b-2f818cabeb5d"; // 1022
	...
	public static final String OPEN_WOUND_OF_EYELID_AND_PERIOCULAR_AREA = "618e30f7-84c3-4884-a497-d85a11934c5a"; // 4049
	
	public static final String HYDROCORTISONE = "124AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"; // 124
	
	public static final String RETROBULBAR_NEURITIS_LEFT_EYE = "1c956854-a086-415b-a1ac-c7fffbe68664"; // 4528
	
	public static final String ACUTE_ATOPIC_CONJUCTIVITIS_RIGHT_EYE = "7ac697c2-49ac-47ea-9c19-e71897f0f4eb"; // 4125
	...
	public static final String UPPER_RESPIRATORY_TRACT_INFECTION = "4d962c5d-f2dc-46a9-93d8-9ddc4fe663a2"; // 1149
	
	public static final String UPPER_RESPIRATORY_TRACT_HYPERSENSITIVITY_REACTION_SITE_UNSPECIFIED = "92667e83-93bf-4054-90b9-187aef473f01"; // 4410
	...
	public static final String CARDIVASCULAR_CONDITIONS = "64cf24cc-f7c0-464b-9e8d-07f3a9cf9504"; // 1755
	
	// VIOLENCE RELATED INJURIES
	public static final String VIOLENCE_RELATED_INJURIES = "72d91e67-0f6e-41dd-87ce-0c510c99aa2a"; // INPUT CONCEPT ID IF/WHEN ADDED
	...
	public static final String OTHER_CENTRAL_NERVOUS_SYSTEM_CONDITIONS = "41297379-6733-4df0-b6bb-4123f25becc6"; // 4558
	...
	public static final String VIRAL_HAEMORRHAGIC_FEVER = "4cd84add-83cd-4c09-8825-1aea071afa57"; // 4289
	
	// PLAGUE
	public static final String PLAGUE = "d86f7c87-7023-4dab-9334-b217fa09d857"; // 1709
	
	// DEATHS_DUE_TO_ROAD_TRAFFIC_INJURIES
	public static final String DEATHS_DUE_TO_ROAD_TRAFFIC_INJURIES = "72d91e67-0f6e-41dd-87ce-0c510c99aa2a"; // TO BE POPULATED
	...
	public static final String MUSCULAR_DYSTROPHY = "71c88f51-104b-491c-bd4c-644816c845f4"; // 4567 desc for this match MUSCULAR SKELETON
	...
	public static final String DISEASE_OF_PUERPERUM_AND_CHILD_BIRTH = "be97c89d-62f2-42f7-98c2-58481de66aec"; // 4445
	
	// ARTHRITIS
	public static final String ARTHRITIS = "0512a0da-662f-481e-a271-9773aec9a658"; // 1037 ADD MORE CONCEPTS DIAGNOSIS
